                    ...
                    <div class="row g-20">
                            ...
                            <div class="card border border-gray-100">
                                <div class="card-body p-8">
                                    <a href="#" class="bg-main-100 rounded-16 overflow-hidden text-center mb-8 h-164 flex-center">
                                        <img src="as/img/course/13.jpg" alt="Course Image" class="cover-img">
                                    </a>
                                    <div class="p-8">
                                      
                                        <h5 class="mb-8"><a href="" class="hover-text-main-600">ATOM</a></h5>
                        ...
                        <div class="col-xxl-3 col-lg-4 col-sm-6">
                            <div class="card border border-gray-100">
                                <div class="card-body p-8">
                                    <a href="#" class="bg-main-100 rounded-16 overflow-hidden text-center mb-8 h-164 flex-center">
                                        <img src="as/img/course/14.jpg" alt="Course Image" class="cover-img">
                                    </a>
                                    <div class="p-8">
                               
                                        <h5 class="mb-8"><a href="" class="hover-text-main-600">ANIMAL CELL</a></h5>
                        ...
                        <div class="col-xxl-3 col-lg-4 col-sm-6">
                            <div class="card border border-gray-100">
                                <div class="card-body p-8">
                                    <a href="#" class="bg-main-100 rounded-16 overflow-hidden text-center mb-8 h-164 flex-center">
                                        <img src="as/img/course/15.jpg" alt="Course Image" class="cover-img">
                                    </a>
                                    <div class="p-8">
                                  
                                        <h5 class="mb-8"><a href="#" class="hover-text-main-600">PLANT CELL</a></h5>
                        ...
                        <div class="col-xxl-3 col-lg-4 col-sm-6">
                            <div class="card border border-gray-100">
                                <div class="card-body p-8">
                                    <a href="career.html" class="bg-main-100 rounded-16 overflow-hidden text-center mb-8 h-164 flex-center">
                                        <img src="as/img/course/16.jpg" alt="Course Image" class="cover-img">
                                    </a>
                                    <div class="p-8">
                                  
                                        <h5 class="mb-8"><a href="career.html" class="hover-text-main-600">HUMAN HEART</a></h5>
                        ...
                        <div class="col-xxl-3 col-lg-4 col-sm-6">
                            <div class="card border border-gray-100">
                                <div class="card-body p-8">
                                    <a href="#" class="bg-main-100 rounded-16 overflow-hidden text-center mb-8 h-164 flex-center">
                                        <img src="as/img/course/17.jpg" alt="Course Image" class="cover-img">
                                    </a>
                                    <div class="p-8">
                               
                                        <h5 class="mb-8"><a href="#" class="hover-text-main-600">FEMALE REPRODUCTIVE ORGAN</a></h5>
