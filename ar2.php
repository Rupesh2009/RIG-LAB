...
<!-- Breadcrumb End -->
  ...
  <div class="card border border-gray-100 w-100" style="border-radius: 16px; overflow: hidden; margin-top: 20px;">
    <div class="card-body p-0" style="background-color: #eaf0ff; height: 80vh;">
      <model-viewer 
        src="animal_cell_2.0_-_annotated_in_english (1).glb"
        ar 
        ar-modes="webxr scene-viewer quick-look" 
        camera-controls 
        auto-rotate 
        style="width: 100%; height: 100%; background: #eaf0ff;"
        shadow-intensity="1"
        exposure="1">
        <button slot="ar-button" style="position: absolute; bottom: 16px; left: 50%; transform: translateX(-50%); background: #3b82f6; color: white; padding: 10px 16px; border: none; border-radius: 8px;">
          View in AR
        </button>
      </model-viewer>
    </div>
