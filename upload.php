...
.upload-section {
  ...
  padding: 80px 60px;
  padding-top: 40px; /* Ensures space from the top white border */
  display: flex;
  justify-content: center;
  border-radius: 20px;
  margin-top: 20px; /* Space between top and the blue box */
}
...
.upload-card:hover {
  ...
  box-shadow: 0 35px 70px rgba(45, 125, 246, 0.2);
}
...
.upload-card button[type="submit"] {
  ...
  font-weight: 600;
  cursor: pointer;
  box-shadow: 0 10px 25px rgba(45, 125, 246, 0.3);
            ...
            <div class="card mt-24">
                <div class="card-body">
                    ...
                    <div class="container-fluid">
                        ...
                        <h2 class="mb-4">📘 Upload Chapter PDF</h2>
